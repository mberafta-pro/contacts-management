...
export class UnhandledConnectorAccessCreationStrategyError extends DomainError<UnhandledConnectorAccessCreationStrategyContext> {
  constructor(source: ConnectorSource) {
    super('unhandled.connector.access.creation.strategy.error', { source });
  }
}
